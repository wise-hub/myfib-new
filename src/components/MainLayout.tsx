...
const MainLayout = ({ children }: MainLayoutProps) => {
  ...
  useEffect(() => {
    ...
    setCustomerData(storedData ? JSON.parse(storedData) : {});
  }, []);
    ...
    <div className={navStyles.mainWrapper}>
      ...
      <header className={navStyles.topNavbar}>
        <div className={navStyles.topNavbarContent}>
          ...
          <div className={navStyles.topNavbarRight}>
            <Link href="/en" className={navStyles.topNavLink}>
              ENGLISH
            </Link>
            <Link href="/help" className={navStyles.topNavLink}>
              ПОМОЩ
            </Link>
            <Link href="/messages" className={navStyles.topNavLink}>
              СЪОБЩЕНИЯ
            </Link>
            <Link href="/notifications" className={navStyles.topNavLink}>
              ИЗВЕСТИЯ
            </Link>
            <Link href="/settings" className={navStyles.topNavLink}>
              НАСТРОЙКИ
            </Link>
            <button
      ...
      <div className={navStyles.mainContainer}>
        <nav className={navStyles.leftNavbar}>
          ...
          <button className={navStyles.primaryButton}>НОВ ПРЕВОД</button>
          <Link href="/dashboard" className={navStyles.navLink}>
            Начало
          </Link>
          <Link href="/accounts" className={navStyles.navLink}>
            Сметки
          </Link>
          <Link href="/cards" className={navStyles.navLink}>
            Карти
          </Link>
        </nav>

        <div className={navStyles.contentContainer}>{children}</div>
      </div>
    </div>
  );
};
